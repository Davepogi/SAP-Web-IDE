sap.ui.define([
		...
		return BaseObject.extend("costchangeapproval.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias costchangeapproval.model.ListSelector
			 */
			 ...
			 * @return {costchangeapproval.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
